...
public class SimpleBean implements org.apache.thrift.TBase<SimpleBean, SimpleBean._Fields>, java.io.Serializable, Cloneable, Comparable<SimpleBean> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SimpleBeanStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SimpleBeanTupleSchemeFactory();
  ...
  public SimpleBean setIntTest(int intTest) {
    this.intTest = intTest;
    setIntTestIsSet(true);
    return this;
  }
  ...
  public SimpleBean setLongTest(long longTest) {
    this.longTest = longTest;
    setLongTestIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case INT_TEST:
      if (value == null) {
        ...
        setIntTest((java.lang.Integer)value);
      }
      break;
    ...
    case LONG_TEST:
      if (value == null) {
        ...
        setLongTest((java.lang.Long)value);
      }
      break;
  ...
  public int compareTo(SimpleBean other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIntTest()).compareTo(other.isSetIntTest());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLongTest()).compareTo(other.isSetLongTest());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLongTest()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SimpleBean(");
    boolean first = true;
  ...
  private static class SimpleBeanStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SimpleBeanStandardScheme getScheme() {
      return new SimpleBeanStandardScheme();
    }
  }

  private static class SimpleBeanStandardScheme extends org.apache.thrift.scheme.StandardScheme<SimpleBean> {
  ...
  private static class SimpleBeanTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SimpleBeanTupleScheme getScheme() {
      return new SimpleBeanTupleScheme();
    }
  }

  private static class SimpleBeanTupleScheme extends org.apache.thrift.scheme.TupleScheme<SimpleBean> {
